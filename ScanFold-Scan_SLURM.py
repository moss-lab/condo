...
w = open(myfasta+".step_win_rand_strand."+str(step_size)+"_"+str(window_size)+"_"+str(randomizations)+"_"+str(strand)+".txt", 'w')
...
def energies(seq_list):
    ...
    energy_list = multiprocessing(rna_folder, [sequence for sequence in seq_list], 4)
